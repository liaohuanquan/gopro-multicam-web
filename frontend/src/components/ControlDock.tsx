...
export function ControlDock({ cameraCount, explicitlySelected, startDisabled, stopDisabled, session, onStart, onStop, onCancel }: ControlDockProps) {
